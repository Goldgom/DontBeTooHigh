package org.goldgom.dontbetoohigh;
...
import org.goldgom.dontbetoohigh.data.MobLivingEnvironmentConfigManager;
import org.goldgom.dontbetoohigh.utils.IEntityWalkDetect;
import org.goldgom.dontbetoohigh.utils.IRealEnvironmentPlayer;
import org.goldgom.dontbetoohigh.world.Air;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(Dontbetoohigh.MODID)
public class Dontbetoohigh {

    // Define mod id in a common place for everything to reference
    public static final String MODID = "dontbetoohigh";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public Dontbetoohigh() {
    ...
    public void onLivingTick(LivingBreatheEvent event) {
        ...
        if (entity.tickCount % 20 == 0) {
            ...
            if (entity instanceof IRealEnvironmentPlayer player) {
            ...
            if(d_airConcentration <= 0){
                ...
                if(entity.isSprinting() ||(entity instanceof IEntityWalkDetect new_entity&& new_entity.isWalking()) || isMining)
                {
                    d_airConcentration *= 100;
...
//                    }
            ...
            if(entity instanceof IRealEnvironmentPlayer player&& isMining)
            {
                d_airConcentration += 40;
            }
